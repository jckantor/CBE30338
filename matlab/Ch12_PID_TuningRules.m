...
%% Demonstration of the Gain Margin
...
% Disturbance control Ky

Ky = P + I + D;

% Setpoint controller Kr

Kr = 0.0*P + I;

% Closed-loop transfer functions

Hyd =       Gd/(1 + Gp*Gv*Ky*Gm);
Hyr = Gp*Gv*Kr/(1 + Gp*Gv*Ky*Gm);
Hud =   -Ky*Gd/(1 + Ky*Gm*Gp*Gv);
Hur =       Kr/(1 + Gp*Gv*Ky*Gm);
...
% Observations
%
% * The disturbance rejection properties are the same.
% * Setpoint response is much better. Less overshoot with less control
% effort.
