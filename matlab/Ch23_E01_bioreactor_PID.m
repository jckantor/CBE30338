...
plot(t,xout(:,1),'LineWidth',2);
[y,t] = step(Gp,tstop);
y = 0.1*D1*y;
hold on;
plot(t,y+x0(1),'--','Linewidth',2);
hold off
...
legend('D_0 + 10%','D_0 + 10% (linear)');


%%

mdl  = 'Ch23_E01_bioreactor_mpc_mdl';
D = D1;
[t,xout,yout] = sim(mdl);
